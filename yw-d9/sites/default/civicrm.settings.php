...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://rdbauuiv_yw_d9_development:catmando%407F%21S.%5Dp8LYr3y@localhost:3306/rdbauuiv_yw_d9_development?new_link=true');
}

// Additional settings generated by installer:
$civicrm_paths['civicrm.files']['url'] = 'https://dev.yellow-website.com/yw-d9/yw-d9//sites/default/files/civicrm';
$civicrm_paths['civicrm.files']['path'] = '/home/rdbauuiv/dev.yellow-website.com/yw-d9/sites/default/files/civicrm';
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://rdbauuiv_yw_d9_development:catmando%407F%21S.%5Dp8LYr3y@localhost:3306/rdbauuiv_yw_d9_development?new_link=true');
  }
}
...
$civicrm_root = '/home/rdbauuiv/dev.yellow-website.com/yw-d9/vendor/civicrm/civicrm-core/';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/home/rdbauuiv/dev.yellow-website.com/yw-d9/sites/default/files/civicrm/templates_c');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'https://dev.yellow-website.com/yw-d9/yw-d9');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '4BxdTE7iRGzPDNQZqpJStmSXVv5I7oD1NR4RZMZAE');
}
...
if (!defined('CIVICRM_CRED_KEYS') ) {
  define( '_CIVICRM_CRED_KEYS', 'aes-cbc:hkdf-sha256:YKnG4kyfW3NITDixYaq6akcurYM9hWBcXx0ZGhLdCkrfbXskg');
...
if (!defined('CIVICRM_SIGN_KEYS') ) {
  define( '_CIVICRM_SIGN_KEYS', 'jwt-hs256:hkdf-sha256:Q8Z4VLuTZDt5N6MyGOtzS14Hedgw7C6tsn1LwAgfltNvWdGk9yjw');
...
// define( 'CIVICRM_MAIL_LOG', '/home/rdbauuiv/dev.yellow-website.com/yw-d9/sites/default/files/civicrm/templates_c/mail.log');
// }
